# ============================================================
# KNOWLEDGE BASE - CAU HINH MAY TINH CHO SINH VIEN AI
# ============================================================

CPU_KB = {
    "lap_trinh_co_ban": "Core i3/i5 hoac Ryzen 3/5",
    "machine_learning_co_ban": "Core i5 hoac Ryzen 5 tro len",
    "deep_learning": "Core i5/i7 H-series hoac Ryzen 5/7 H-series",
...
RAM_KB = {
    "lap_trinh_co_ban": "Toi thieu 8GB, khuyen nghi 16GB neu co dieu kien",
    "machine_learning_co_ban": "Toi thieu 16GB",
    "deep_learning": "Toi thieu 16GB, khuyen nghi 32GB",
...
SSD_KB = {
    "lap_trinh_co_ban": "Toi thieu 256GB, khuyen nghi 512GB",
    "machine_learning_co_ban": "Toi thieu 512GB",
    "deep_learning": "512GB den 1TB",
...
GPU_KB = {
    "lap_trinh_co_ban": "Khong bat buoc GPU roi",
    "machine_learning_co_ban": "GPU roi khong bat buoc, uu tien CPU va RAM",
    "deep_learning": "Nen co GPU roi RTX 3050/4050 tro len",
...
MAN_HINH_KB = {
    "lap_trinh_co_ban": "Full HD, 14 den 15.6 inch",
    "machine_learning_co_ban": "Full HD, nen co khong gian hien thi tot",
    "deep_learning": "Full HD, 15.6 inch tro len neu can lam viec lau",
...
GIAI_THICH_KB = {
    "lap_trinh_co_ban": "Ban chu yeu hoc lap trinh co ban, khong yeu cau huan luyen mo hinh AI nang, nen cau hinh vua phai la phu hop.",
    "machine_learning_co_ban": "Ban co hoc Machine Learning, can CPU tot va RAM du lon de xu ly du lieu, chay Python va cac mo hinh ML co ban.",
    "deep_learning": "Ban co hoc Deep Learning, nen he thong uu tien CPU manh, RAM lon va GPU roi de ho tro huan luyen mo hinh.",
